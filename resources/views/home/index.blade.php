...
@section('content')
    ...
    <section id="mobil">
        <div class="container py-5">
            <div class="row mb-3">
                <h3 class="text-center">Beli Mobil</h3>
            </div>
            @livewire('buy-cars')
        </div>
    </section>
    <section id="about">
        <div class="container py-5">
            <div class="row text-center">
                ...
                <p>"Silahkan hubungi kami untuk informasi lebih lanjut tentang layanan kami, kami akan menjawab
                    pertanyaan-pertanyaan anda dengan senang hati"</p>
                <p>081-393-888-001</p>
            </div>
        </div>
    </section>
